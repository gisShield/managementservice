package me.nvliu.management.utils.sensi;
...
public class SensitiveFilter implements Serializable{
	...
	public static final SensitiveFilter DEFAULT = new SensitiveFilter(
			new BufferedReader(new InputStreamReader(
					ClassUtils.class.getClassLoader().getResourceAsStream("sensi_words.txt")
	...
	/*新加方法，从filter方法拷贝过来进行修改*/

	public String hasSensi(String sentence,char replace){
	...
	public String delSpaceAndLineTag(String key) {
		String regEx="(\\r\\n|\\n|\\t|\\s*)";
	 ...
	 * @return
	 */
	public  String delAllSymbol(String key){
		String regEx="[~！@#￥%……&*（）——+|{}：。，”“？》《~!@#$%^&*()_+|{}:\"<>?.,]";
		Pattern p = Pattern.compile(regEx);
		Matcher m = p.matcher(key);
		return m.replaceAll("").trim();
